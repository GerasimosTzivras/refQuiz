...
const Quiz = () => {
  ...
  const startQuiz = async () => {
    if (chosenCategory && chosenDifficulty) {
      const chosenCategoryElement = document.getElementById(
        `categoryButton_${chosenCategory}`
      );
      ...
      const difficultiesCardElement =
        document.getElementById("difficultiesCard");
      ...
      show({
        header: "Φάουλ!",
        message: "Πρέπει να διαλέξεις κατηγορία και επίπεδο",
        duration: 3000,
        color: "warning",
      });
    }
            ...
            <IonCol size="12">
              <IonCard id="categoriesCard" className="animate__animated">
                <IonCardHeader className="ion-text-center">
                  <IonCardSubtitle>Διάλεξε κατηγορία</IonCardSubtitle>
                </IonCardHeader>
          ...
          <IonRow className={styles.difficultyContainer}>
            <IonCol size="12">
              <IonCard id="difficultiesCard" className="animate__animated">
                <IonCardHeader className="ion-text-center">
                  <IonCardSubtitle>Διάλεξε επίπεδο</IonCardSubtitle>
                </IonCardHeader>
